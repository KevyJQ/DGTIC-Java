...
public class BaseDeDatos {
	...
	static {
		...
		est.setMaterias(new Materia(2l, "Programación", 10), new Materia(3l, "Lógica", 10));
		estudiantes.add(est);
		...
		est.setMaterias(new Materia(4l, "Circuitos Lógicos", 10), new Materia(5l, "Lógica de Autómatas", 10));
		estudiantes.add(est);
