...
public class Principal {
	public static void main(String[] args) {
		...
		List<Alumno> alm=lista.stream()				
				.filter(alum->(alum.getNombre().equals("Jose")))
				/*
				 * Haz un filtro que me regresa a Jose, pero como puede haber varios Jose en la lista, 
				 * solo toma al primero que se encuentra en la lista 
				*/
				.collect(toList());	//Creame la lista 
		String cadena=sl.exportarCSV(alm.get(0));		
